...
function goods() {
    // body...
    document.getElementById('goods').className = "layui-btn ayui-btn-radius layui-btn-normal all-goods";
    document.getElementById('coms').className = "layui-btn ayui-btn-radius layui-btn-primary all-goods";
}

function coms() {
    // body...
    document.getElementById('goods').className = "layui-btn ayui-btn-radius layui-btn-primary all-goods";
    document.getElementById('coms').className = "layui-btn ayui-btn-radius layui-btn-normal all-goods";
}